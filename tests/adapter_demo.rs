...
fn test_session_manager() {
    ...
    let client = Arc::new(NoiseClient::<_, ()>::new_direct("kid", b"dev-client", ring_client));
    let server = Arc::new(NoiseServer::<_, ()>::new_direct("kid", b"dev-server", ring_server.clone(), 3));
